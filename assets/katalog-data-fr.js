  ...
  sections:[
    ...
    {id:"basinc", kicker:"04", title:"Pressure Sensors", sub:"Pressure transmitters, switches and gauges", glyph:"pressure",
     products:[
      ...
      {code:"NT-DPS-A", img:"assets/products/NT-DPS-A.png", name:"Pressostat différentiel air", glyph:"diffpressure",
      ...
      {code:"NT-DPS-L", img:"assets/products/NT-DPS-L.png", name:"Pressostat différentiel liquide", glyph:"diffpressure",
    ...
    {id:"kontrol", kicker:"06", title:"Process Indicators and Controllers", sub:"Monitoring, control and signal transmission", glyph:"panel",
     products:[
      ...
      {code:"NT-MLC", img:"assets/products/NT-MLC.png", name:"Encodeur linéaire magnétique", glyph:"angle",
      ...
      {code:"NT-MLS-E", img:"assets/products/NT-MLS-E.png", name:"Capteur de lecture magnétique", glyph:"angle",
      ...
      {code:"NT-PLC", img:"assets/products/NT-PLC.png", name:"Règle linéaire potentiométrique", glyph:"angle",
      ...
      {code:"NT-MSC", img:"assets/products/NT-MSC.png", name:"Règle linéaire magnétostrictive", glyph:"angle",
      ...
      {code:"NT-OLC", img:"assets/products/NT-OLC.png", name:"Encodeur linéaire optique", glyph:"angle",
      ...
      {code:"NT-INS", img:"assets/products/NT-INS.png", name:"Inclinomètre / Capteur d'inclinaison", glyph:"angle",
       desc:"Inclinomètre MEMS pour la surveillance d'inclinaison, le nivellement de plateformes et les engins mobiles.",
       specs:[["Plage","±10° … ±90°"],["Résolution","0,01°"],["Précision","±0,1°"],["Sortie","4–20 mA, CANopen, Modbus"],["Protection","IP67"]],
       uses:"Surveillance d'inclinaison d'engins, positionnement de suiveurs solaires, nivellement.",
       sectors:"Construction, énergies renouvelables, maritime, mines."},
      {code:"NT-TMR", img:"assets/products/NT-TMR.png", name:"Minuterie / Chronomètre", glyph:"panel",
      ...
      {code:"NT-STC", img:"assets/products/NT-STC.png", name:"Régulateur programmable", glyph:"controller",
    ...
    {id:"mekanik", kicker:"07", title:"Mechanical Control", sub:"Actuators, solenoid valves and valves", glyph:"valve",
     products:[
      ...
      {code:"NT-SOL-L", img:"assets/products/NT-SOL-L.png", name:"Électrovanne grand diamètre", glyph:"solenoid",
      ...
      {code:"NT-BDV", img:"assets/products/NT-BDV.png", name:"Vanne à impulsion (membrane)", glyph:"solenoid",
    ...
    {id:"eltipi", kicker:"08", title:"Handheld Instruments and Data Logging", sub:"Field measurement, analysis and data recording", glyph:"handheld",
     products:[
      ...
      {code:"NT-CO2", img:"assets/products/NT-CO2.png", name:"Transmetteur CO₂ / temp. / humidité", glyph:"humidity",
      ...
      {code:"NT-GDC", img:"assets/products/NT-GDC.png", name:"Détecteur de gaz catalytique", glyph:"gasdetect",
      ...
      {code:"NT-GDI", img:"assets/products/NT-GDI.png", name:"Détecteur de gaz infrarouge", glyph:"gasdetect",
      ...
      {code:"NT-GDE", img:"assets/products/NT-GDE.png", name:"Détecteur de gaz électrochimique", glyph:"gasdetect",
