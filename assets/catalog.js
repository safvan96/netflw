...
(function(){
  ...
  const P = [
    ...
    {n:"Magnetic Level Sensor",code:"NT-MLP",c:"level",g:"maglevel",t:0,ind:["water","chemical"],tags:["Point Level"],s:[["IP67","Protection"],["150°C","Max temp"]],d:"Compact magnetic float + reed switch for pump protection and high/low alarms. Vertical or side mount.",img:"assets/img/maglevel.png"},
