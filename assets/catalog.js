...
(function(){
  ...
  const P = [
    ...
    {n:"Motorized Level Sensor",code:"NT-MLS",c:"level",g:"motor",t:0,ind:["mining","food"],tags:["Solids Detection"],s:[["Relay","Output"],["IP65","Protection"]],d:"Rotary-paddle detection of bulk solids, grain silos, cement, plastic granule and powder storage."},
