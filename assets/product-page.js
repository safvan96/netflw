        ...
        <div class="quote-side" id="quote">
          ...
          <div style="border:1px solid var(--line);border-radius:var(--r-lg);padding:24px;background:#fff;box-shadow:var(--shadow-sm);margin-top:16px">
            ...
            <div style="display:flex;flex-direction:column;gap:10px;margin-top:16px">
              ...
              <a href="katalog-en.html" class="btn btn-ghost navCatalogLink" style="justify-content:flex-start;width:100%" onclick="(function(e){e.preventDefault();var l=(typeof PMI18n!=='undefined'?PMI18n.get():'en');var m={en:'katalog-en.html',tr:'katalog.html',ar:'katalog-ar.html',ru:'katalog-ru.html'};window.open(m[l]||m.en)})(event)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><path d="M4 19.5v-15A2.5 2.5 0 016.5 2H20v20H6.5a2.5 2.5 0 010-5H20"/></svg> View Online Catalog</a>
              <a href="assets/pdf/en/netflow-catalog-en.pdf" class="btn btn-ghost" style="justify-content:flex-start;width:100%" onclick="(function(e){e.preventDefault();var l=(typeof PMI18n!=='undefined'?PMI18n.get():'en');var ls=['en','tr','ar','ru'];var pl=ls.includes(l)?l:'en';var a=document.createElement('a');a.href='assets/pdf/'+pl+'/netflow-catalog-'+pl+'.pdf';a.download='NetFlow-Catalog-'+pl.toUpperCase()+'.pdf';a.click()})(event)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><path d="M12 3v12m0 0l-4-4m4 4l4-4M5 21h14"/></svg> Download Catalog PDF</a>
            </div>
          </div>
        </div>
      </aside>
