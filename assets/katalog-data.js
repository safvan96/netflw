...
window.NF_CAT = {
  ...
  ui:{
    principle:"Calisma Prensibi", contents:"Icindekiler",
    jumpHint:"Urun sayfasina gitmek icin urun adina tiklayiniz",
    corporate:"Kurumsal", aboutTitle:"Biz Kimiz", aboutLabel:"Biz Kimiz",
    uses:"Uygulamalar", sectorsLong:"Hizmet Verilen Sektorler", sectors:"Sektorler",
    variantImgs:"Model Gorselleri", notes:"Notlar", models:"Modeller",
    specs:"Teknik Ozellikler", contact:"Iletisim", address:"Adres",
    waCta:"WhatsApp ile mesaj gonderin", exportBrand:"VFA Elektronik'in ihracat markasi",
    coverVfa:"VFA Elektronik'in ihracat markasi · 12 yillik uretim tecrubesi",
    tagline:"Endustriyel Olcum", coverLabel:"Kapak", backLabel:"Arka Kapak",
    coverEyebrow:"Urun Katalogu · 2026",
    coverH1:"Olc.", coverH1em:"Kontrol et.",
    coverLede:"Debi, seviye, basinc ve sicaklik olcumu icin uctan uca enstrumantasyon cozumleri. Turkiye'de uretilmekte ve TURKAK akrediteli laboratuvarimizda kalibre edilmektedir.",
    madeIn:"Turkiye Uretimi",
    calibTitle:"Kalibrasyon Guvencesi",
    calibBody:"Elektromanyetik debimetreler, TURKAK akrediteli (AB-0354-K) ISO/IEC 17025:2017 laboratuvarimizda 1-350 m³/h araliginda ±%0,27 belirsizlikle kalibre edilmektedir. EA ve ILAC karsilikli taninma anlasmalari kapsaminda 100'den fazla ulkede gecerli, izlenebilir kalibrasyon sertifikasi cihazla birlikte verilmektedir. Diger tum urunler Yerli Mali belgeli, ISO 9001 kalite sistemi ve CE beyannamesiyle sunulmaktadir.",
    projectTitle:"Proje Talebi",
    projectBody:"Olcum noktalarinizi, akiskan verilerinizi ve hat olculerinizi paylastiginizda muhendislik ekibimiz uygun urun secimi, boyutlandirma ve fiyat teklifi ile destek verecektir. Ozel uretim ve ozel proses gereksinimleri icin dogrudan bize ulasiniz.",
    closingLabel:"Otomasyon", closingScreen:"Otomasyon ve Tasarim",
    backH2:"Hassas olcum,<br>guvenilir veri.",
    backSub:"Urun secimi, uygulama destegi ve fiyat teklifi icin bizimle iletisime gecin. Yerli uretim, hizli teslimat ve dogrudan muhendislik destegi.",
    contLabel:"Devami",
    rights:"© 2026 Net Flow · Tum haklari saklidir",
  },
