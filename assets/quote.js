...
const PRODUCTS = [
  ...
  {code:'NT-MBP',cat:'level',cfg:['temp','pn','conn','ip'],
  ...
  {code:'NT-VMS',cat:'level',cfg:['supply','outSw','ip'],
  ...
  {code:'NT-VKS-H 3100/2100',cat:'process',cfg:['range','output','ip'],
  ...
  {code:'NT-VRS',cat:'level',cfg:['range','output','ip','supply'],
  ...
  /* --- Flow Meters --- */
  {code:'NT-VTR',cat:'flow',cfg:['dn','output','conn','ip'],
  ...
  {code:'NT-VAK',cat:'flow',cfg:['output','ip','supply'],
  ...
  {code:'NT-VDD',cat:'flow',cfg:['dn','output','conn','pn'],
  ...
  {code:'NT-VDD-O',cat:'flow',cfg:['dn','output','conn','pn'],
  ...
  {code:'NT-S415',cat:'flow',cfg:['dn','output','ip'],
  ...
  {code:'NT-VAS',cat:'switch',cfg:['dn','outSw','ip','temp'],
  ...
  {code:'NT-VAG',cat:'flow',cfg:['dn','mat','temp'],
  ...
  /* --- Level --- */
  {code:'NT-VUS',cat:'level',cfg:['range','output','ip','supply'],
  ...
  {code:'NT-VHL',cat:'level',cfg:['range','output','ip','mat'],
  ...
  {code:'NT-VKS',cat:'level',cfg:['range','output','ip'],
  ...
  {code:'NT-VLV-VBR',cat:'switch',cfg:['conn','outSw','ip','temp'],
  ...
  {code:'NT-VBT-G',cat:'process',cfg:['range','output','conn','ip'],
  ...
  {code:'NT-VPO',cat:'switch',cfg:['range','outSw','conn'],
  ...
  /* --- Temperature --- */
  {code:'NT-VTC',cat:'temp',cfg:['temp','conn','ip'],
  ...
  {code:'NT-VPT',cat:'temp',cfg:['temp','conn','output','ip'],
  ...
  {code:'NT-VHT',cat:'temp',cfg:['output','ip','supply'],
  ...
  {code:'NT-VBT-G11',cat:'control',cfg:['output','supply'],
  ...
  {code:'NT-VDP-A',cat:'process',cfg:['range','outSw'],
  ...
  {code:'NT-VDP-L',cat:'process',cfg:['range','outSw','ip'],
