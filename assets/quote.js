...
const PRODUCTS = [
  ...
  {code:'NT-AQM',cat:'handheld',cfg:[],
    name:N('pH / EC / TDS Meter','pH / EC / TDS Ölçer','مقياس pH / EC / TDS','pH/EC/TDS-метр'),
    desc:N('Analytical meter for pH, conductivity, TDS, salinity and chlorine measurement.','pH, iletkenlik, TDS, tuzluluk ve klor ölçümü için analitik ölçüm cihazı.','جهاز تحليلي لقياس pH والتوصيل الكهربائي وTDS والملوحة والكلور.','Аналитический прибор для измерения pH, EC, TDS, солёности и хлора.')},
  {code:'NT-TAO',cat:'handheld',cfg:[],
    ...
    desc:N('GPS-based field area meter for agricultural land measurement.','Tarımsal arazi ölçümü için GPS tabanlı alan ölçer.','مقياس مساحة الحقول بالـ GPS للقياسات الزراعية.','GPS-измеритель площади для сельскохозяйственных угодий.')},
