  ...
  sections:[
    ...
    {id:"basinc", kicker:"04", title:"Pressure Sensors", sub:"Pressure transmitters, switches and gauges", glyph:"pressure",
     products:[
      ...
      {code:"NT-DPS-A", img:"assets/products/NT-DPS-A.png", name:"Air Differential Pressure Switch", glyph:"diffpressure",
      ...
      {code:"NT-DPS-L", img:"assets/products/NT-DPS-L.png", name:"Liquid Differential Pressure Switch", glyph:"diffpressure",
    ...
    {id:"kontrol", kicker:"06", title:"Process Indicators and Controllers", sub:"Monitoring, control and signal transmission", glyph:"panel",
     products:[
      ...
      {code:"NT-MLC", img:"assets/products/NT-MLC.png", name:"Magnetic Linear Encoder", glyph:"angle",
      ...
      {code:"NT-MLS-E", img:"assets/products/NT-MLS-E.png", name:"Magnetic Reader Sensor", glyph:"angle",
      ...
      {code:"NT-PLC", img:"assets/products/NT-PLC.png", name:"Potentiometric Linear Ruler", glyph:"angle",
      ...
      {code:"NT-MSC", img:"assets/products/NT-MSC.png", name:"Magnetostrictive Linear Ruler", glyph:"angle",
      ...
      {code:"NT-OLC", img:"assets/products/NT-OLC.png", name:"Optical Linear Encoder", glyph:"angle",
      ...
      {code:"NT-INS", img:"assets/products/NT-INS.png", name:"Inclinometer / Tilt Sensor", glyph:"angle",
       ...
       variants:[
         ["INS 130 Series","Single or dual axis, ±10° to ±90° range, 0.01° resolution, IP67, 4–20 mA and CANopen outputs."],
         ["INS 120 / 110 Series","Compact versions with voltage output for OEM integration, ±15° to ±60° range."],
         ["INC 210 / 110 Series","High-precision inclinometers with digital output, ±0.005° accuracy, for structural monitoring."]
       ],
      ...
      {code:"NT-TMR", img:"assets/products/NT-TMR.png", name:"Timer / Chronometer", glyph:"panel",
      ...
      {code:"NT-STC", img:"assets/products/NT-STC.png", name:"Step Controller (Profile Controller)", glyph:"controller",
    ...
    {id:"mekanik", kicker:"07", title:"Mechanical Control", sub:"Actuators, solenoid valves and valves", glyph:"valve",
     products:[
      ...
      {code:"NT-SOL-L", img:"assets/products/NT-SOL-L.png", name:"Large Solenoid Valve", glyph:"solenoid",
      ...
      {code:"NT-BDV", img:"assets/products/NT-BDV.png", name:"Pulse Jet Valve (Burst Disc)", glyph:"solenoid",
    ...
    {id:"eltipi", kicker:"08", title:"Handheld Instruments and Data Logging", sub:"Field measurement, analysis and data recording", glyph:"handheld",
     products:[
      ...
      {code:"NT-ANM", img:"assets/kat/p30_3.png", name:"Anemometer", glyph:"anemo",
      ...
      {code:"NT-SLM", img:"assets/kat/p30_4.png", name:"Sound Level (Decibel) Meter", glyph:"sound",
      ...
      {code:"NT-GLD", img:"assets/kat/p30_5.png", name:"Gas Leak Detector", glyph:"gasdetect",
      ...
      {code:"NT-AQM", img:"assets/kat/p30_7.png", name:"pH, EC, TDS and Chlorine Meters", glyph:"analytic",
      ...
      {code:"NT-TAO", img:"assets/kat/p30_2.png", name:"GPS Field Area Meter", glyph:"gps",
      ...
      {code:"NT-CO2", img:"assets/products/NT-CO2.png", name:"CO₂ / Temperature / Humidity Transmitter", glyph:"humidity",
      ...
      {code:"NT-GDC", img:"assets/products/NT-GDC.png", name:"Catalytic Gas Detector", glyph:"gasdetect",
      ...
      {code:"NT-GDI", img:"assets/products/NT-GDI.png", name:"Infrared Gas Detector", glyph:"gasdetect",
      ...
      {code:"NT-GDE", img:"assets/products/NT-GDE.png", name:"Electrochemical Gas Detector", glyph:"gasdetect",
      ...
      {code:"NT-DLG", img:"assets/kat/p30_6.png", name:"Data Recorders and Dataloggers", glyph:"logger",
