/* Blog Posts - Net Flow
   ...
   AR → Arap / Korfez / Ortadogu
   RU → Orta Asya / Kafkasya / BDT
   TR → Turkiye ic pazar
*/
window.BLOG_POSTS={
...
<ul>
<li><strong>Raw water intake:</strong> DN200–DN1200</li>
<li><strong>Filter feed lines:</strong> DN150–DN600</li>
<li><strong>Chemical dosing:</strong> DN3–DN25 (miniature meters)</li>
<li><strong>Distribution mains:</strong> DN80–DN500</li>
</ul>
...
<h2>Output & Communication</h2>
<ul>
<li><strong>4–20 mA + HART:</strong> Universal PLC/SCADA compatibility</li>
<li><strong>RS485 Modbus RTU:</strong> Multi-meter digital networks</li>
...
<h2>The Payback</h2>
<p>A utility that drops NRW from 40% to 25% on a 100,000 m³/day network recovers 15,000 m³/day. At typical tariffs, the DMA metering programme pays for itself in 12–18 months.</p>`
},
{slug:"magnetic-level-indicator-replace-glass-gauge",
title:"Why Every Plant Should Replace Glass Level Gauges with Magnetic Indicators",
...
<ul>
<li>Centre-to-centre distance (C/C)</li>
<li>Flange standard and size (DIN, ANSI, JIS)</li>
<li>Operating pressure and temperature</li>
<li>Liquid specific gravity</li>
</ul>

<h2>Add-Ons</h2>
<ul>
<li>4–20 mA transmitter for SCADA</li>
<li>Reed-switch level alarms</li>
<li>Steam jacket for viscous media</li>
</ul>

<p>Every unit is pressure-tested and documented. ATEX/IECEx certificates included for Ex-rated models. Material certificates (EN 10204 3.1) available on request.</p>`
},
{slug:"battery-powered-flow-meter-remote-locations",
title:"Battery-Powered Flow Meters for Off-Grid Water Networks in Africa & Central Asia",
excerpt:"No mains power? No problem. Our battery-operated mag meter runs for 5 years on a single charge with optional GSM data transmission.",
category:"Remote Metering",
date:"2026-09-08",
...
<h2>Real Application: Rural Water Supply in East Africa</h2>
<p>A water utility managing 40 rural boreholes across a 200 km radius needs flow data from each site but can't justify grid connection or solar for every one. The NT-VMF-BT installed at each borehole sends daily volume totals via GSM to a central dashboard. No site visits for data collection, no power infrastructure, no ongoing consumable costs.</p>

<h2>Calibration</h2>
<p>Same TÜRKAK-accredited calibration as our mains-powered meters. Same ±0.27% uncertainty. Same internationally-recognised certificate. The battery version compromises on nothing except power consumption.</p>`
},
{slug:"flow-meter-wastewater-treatment-plant",
title:"Flow Measurement in Wastewater Treatment: What Works and What Doesn't",
excerpt:"Wastewater is aggressive, unpredictable, and full of solids. Choosing the wrong meter costs more in downtime than the meter itself.",
category:"Wastewater",
date:"2026-09-06",
image:"assets/products/NT-VMF-P.png",
content:`<h2>Wastewater Is Not Clean Water</h2>
...
<h3>Electrodes</h3>
<ul>
<li><strong>316L:</strong> Fine for municipal wastewater.</li>
<li><strong>Hastelloy C-276:</strong> Industrial wastewater with chlorides or acids.</li>
</ul>

<h2>Critical Features</h2>
<ul>
<li><strong>Empty-pipe detection:</strong> Prevents false readings during tank drainage or pump-down.</li>
<li><strong>Self-cleaning electrodes:</strong> Our electrode geometry minimises grease build-up.</li>
<li><strong>IP68 protection:</strong> Wastewater meter chambers flood regularly.</li>
</ul>

<p>From inlet works to final effluent, we can configure the right meter for every measurement point in the plant.</p>`
}
],
...
date:"2026-09-14",
image:"assets/products/NT-VMF-BT.png",
content:`<h2>Ce que le terrain impose</h2>
<p>Quiconque a travaillé sur un réseau d'eau à <strong>Dakar, Douala ou Abidjan</strong> sait que les conditions n'ont rien à voir avec l'Europe. L'eau brute de captage est chargée en sable et en matières en suspension. La température ambiante dépasse régulièrement les 45°C. Les chambres de comptage sont inondées à chaque saison des pluies. Et l'alimentation électrique peut couper sans prévenir.</p>
...
<li>Version IP68 pour les installations submersibles</li>
</ul>

<h2>Quel revêtement choisir ?</h2>
<p><strong>Ébonite (caoutchouc dur) :</strong> C'est le choix par défaut pour l'eau brute en Afrique de l'Ouest. Résistant à l'abrasion, économique, disponible de DN50 à DN3000.</p>
...
excerpt:"Les slurries miniers détruisent les débitmètres classiques en quelques mois. Voici comment choisir un appareil qui dure.",
category:"Mines & Carrières",
date:"2026-09-12",
image:"assets/products/NT-VMF-P.png",
content:`<h2>Le problème avec les slurries</h2>
<p>Dans une mine de bauxite en <strong>Guinée-Conakry</strong>, un pipeline de pulpe transporte un mélange contenant 40 à 60% de particules solides. Le fluide est abrasif, parfois acide, et les variations de débit sont brutales. Un débitmètre standard avec un revêtement en caoutchouc ordinaire s'use en quelques mois. Les électrodes se corrodent. Le signal devient instable.</p>
...
<li>Dérive de zéro minimale</li>
</ul>

<h2>Revêtement polyuréthane</h2>
<p>Pour les pulpes abrasives, le polyuréthane offre une résistance à l'usure <strong>5 fois supérieure</strong> au caoutchouc. C'est le choix recommandé pour le transfert de minerai, les circuits de broyage et les lignes de décantation.</p>

<h2>Électrodes adaptées</h2>
<ul>
<li><strong>Hastelloy C-276 :</strong> Standard pour la majorité des applications minières</li>
<li><strong>Carbure de tungstène :</strong> Pour les slurries les plus agressifs</li>
<li><strong>Titane :</strong> Pour les eaux acides de drainage minier (AMD)</li>
</ul>

<h2>Étalonnage</h2>
<p>Chaque débitmètre quitte notre usine avec un certificat d'étalonnage TÜRKAK ISO/IEC 17025, reconnu dans les pays de la CEDEAO, de la CEMAC et de la SADC sans ré-étalonnage local.</p>`
},
{slug:"indicateur-niveau-magnetique-raffineries-algerie-maroc",
title:"Remplacer les hublots en verre dans les raffineries d'Algérie et du Maroc : la solution magnétique",
excerpt:"Les indicateurs de niveau à verre sont un risque permanent dans les installations pétrolières. L'indicateur magnétique à bypass élimine ce risque.",
...
<h2>Nos modèles pour le pétrole et le gaz</h2>
<ul>
<li><strong>NT-MBYEX :</strong> Certifié ATEX/IECEx. Jusqu'à PN40 / 200°C. Pour réservoirs de brut, séparateurs, ballons de gaz.</li>
<li><strong>NT-MBYB :</strong> Type chaudière. PN100 / 350°C. Indication bicolore haute visibilité. Pour les ballons vapeur des unités de raffinage.</li>
</ul>

<h2>Documentation</h2>
<p>Pour les projets Sonatrach, ALNAFT ou les appels d'offres internationaux en Algérie et au Maroc, nous fournissons :</p>
<ul>
<li>Certificats matière 3.1 (EN 10204)</li>
<li>Certificat d'épreuve hydraulique</li>
<li>Certificats ATEX/IECEx</li>
<li>Plans dimensionnels GA</li>
</ul>`
},
{slug:"comptage-eau-potable-afrique-centrale-ouest",
title:"Comptage d'eau potable : réduire les pertes dans les villes d'Afrique centrale et de l'Ouest",
excerpt:"40 à 55% d'eau perdue dans les réseaux de Kinshasa, Brazzaville, Yaoundé et Conakry. Le comptage de zone est la première étape pour inverser la tendance.",
...
<p>L'instrument clé à chaque frontière de zone : un débitmètre électromagnétique. Précis, sans entretien, insensible aux sédiments.</p>

<h2>Pourquoi pas un compteur mécanique ?</h2>
<p>Parce qu'il s'encrasse, perd sa précision en 2–3 ans, crée une perte de charge et ne fonctionne pas en mesure bidirectionnelle. Le débitmètre électromagnétique fait tout cela sans problème.</p>

<h2>Notre offre</h2>
<ul>
<li>NT-VMF : DN80 à DN1200, précision ±0,2%</li>
<li>IP68 : submersible, pour les chambres de comptage inondables</li>
<li>Version batterie : pour les sites sans alimentation</li>
<li>Sortie Modbus RS485 : pour réseau multi-compteurs centralisé</li>
</ul>

<p>Certificat d'étalonnage TÜRKAK reconnu dans l'espace CEMAC et CEDEAO.</p>`
},
{slug:"debitmetre-industrie-ciment-afrique",
title:"Débitmètres pour les cimenteries d'Afrique : Dangote Cement, Cimencam, LafargeHolcim",
excerpt:"Le dosage d'eau dans le process cimentier exige précision et robustesse. Les débitmètres électromagnétiques s'imposent face aux boues de calcaire et de clinker.",
category:"Ciment & BTP",
date:"2026-09-05",
...
<ul>
<li><strong>Eau de refroidissement :</strong> DN100–DN400, ébonite, 316L, sortie 4-20 mA</li>
<li><strong>Boue de calcaire :</strong> DN80–DN300, polyuréthane, Hastelloy, haute fréquence</li>
<li><strong>Dosage de process :</strong> DN25–DN80, PTFE, 316L</li>
</ul>

<p>Devis configuré sous 24h. Étalonnage TÜRKAK avec certificat reconnu dans 100+ pays.</p>`
}
],
...
<h3>مياه العملية</h3>
<p>DN50–DN600، بطانة PTFE للمياه المعالجة أو إيبونايت للمياه الخام. أقطاب 316L كافية لمعظم الحالات. خرج 4-20 مللي أمبير + HART.</p>
...
date:"2026-09-12",
image:"assets/products/NT-VMF-I.png",
content:`<h2>الأرقام لا تكذب</h2>
<p>في <strong>الأردن</strong>، يتجاوز فاقد المياه 45% في بعض مناطق عمّان. في <strong>مصر</strong>، الشركات القابضة تعلن عن نسب مشابهة في صعيد مصر والدلتا. حتى في <strong>السعودية</strong>، رغم الاستثمارات الضخمة في البنية التحتية، بعض الشبكات القديمة تفقد أكثر من 30%.</p>
<p>الأسباب معروفة: تسربات فيزيائية، وصلات غير مرخصة، عدادات ميكانيكية فقدت دقتها، واستهلاك غير محسوب.</p>

<h2>الحل: مناطق القياس المحددة (DMA)</h2>
<p>تقسيم الشبكة إلى مناطق معزولة، وقياس كل ما يدخل كل منطقة بمقياس تدفق كهرومغناطيسي دقيق. المقارنة بين الداخل والمفوتر تكشف حجم الفاقد الحقيقي.</p>

<h2>لماذا الكهرومغناطيسي وليس الميكانيكي؟</h2>
<ul>
<li>لا يتأثر بالرواسب والرمل في المياه</li>
<li>لا يحتاج صيانة ميكانيكية</li>
<li>يقيس في الاتجاهين (تدفق عكسي)</li>
<li>لا يُحدث فقدان ضغط في الخط</li>
<li>عمر افتراضي يتجاوز 15 سنة</li>
</ul>
...
<p>شهادة معايرة TÜRKAK معترف بها محلياً. تواصل معنا للحصول على عرض سعر.</p>`
},
{slug:"level-indicator-chemical-plants-qatar-kuwait",
title:"مؤشرات المستوى المغناطيسية لمصانع الكيماويات في قطر والكويت",
excerpt:"الأحماض والقواعد تأكل الزجاج. المؤشر المغناطيسي يعمل بدون زجاج، بدون تسريب، بدون توقف.",
...
<p>عوّامة بمغناطيس دائم داخل غرفة مغلقة. المغناطيس يقلب أعلاماً ملونة على المؤشر الخارجي. قراءة مستمرة وواضحة من مسافة 10 أمتار. لا زجاج يُكسر، لا سائل يتسرب.</p>

<h2>اختيار المواد</h2>
<ul>
<li><strong>جسم 316L:</strong> كافٍ لمعظم التطبيقات الكيميائية المعتدلة</li>
<li><strong>جسم Hastelloy:</strong> للأحماض المركزة والبيئات شديدة التآكل</li>
<li><strong>عوّامة مُصممة حسب الكثافة:</strong> السوائل الخفيفة تحتاج عوّامة أطول</li>
</ul>

<h2>خيارات إضافية</h2>
<ul>
<li>مرسل 4-20 مللي أمبير للمراقبة عن بُعد عبر DCS</li>
<li>مفاتيح مستوى (أعلى/أدنى) بتقنية Reed</li>
...
date:"2026-09-07",
image:"assets/products/NT-VMF.png",
content:`<h2>التحلية في منطقة الخليج</h2>
<p>محطات التحلية في <strong>السعودية</strong> (SWCC، المبرّد)، <strong>الإمارات</strong> (DEWA، ADDC)، <strong>الكويت</strong> (MEW) و<strong>عُمان</strong> (OPWP) تنتج ملايين الأمتار المكعبة يومياً. القياس الدقيق ضروري في كل مرحلة: مياه البحر الداخلة، المياه المعالجة، المياه المنتجة، ومياه الصرف المركزة (brine).</p>
...
<h2>مواصفات Net Flow</h2>
<ul>
<li>أقطاب تيتانيوم لخطوط مياه البحر والـ brine</li>
<li>بطانة PTFE أو PFA لخطوط الكيماويات</li>
<li>إيبونايت لخطوط المياه المنتجة كبيرة القطر</li>
<li>حماية IP68 للتركيب في بيئة بحرية</li>
</ul>
...
date:"2026-09-05",
image:"assets/products/NT-VMF-BT.png",
content:`<h2>المشكلة</h2>
<p>عشرات الآبار منتشرة في صحراء <strong>غرب العراق</strong> أو <strong>بادية الأردن</strong> أو <strong>داخلية عُمان</strong>. كل بئر يحتاج قياس تدفق لمعرفة الإنتاج والاستهلاك. لكن لا توجد كهرباء، ولا جدوى اقتصادية من مد خطوط طاقة لكل موقع.</p>

<h2>NT-VMF-BT: القياس بدون كهرباء</h2>
<ul>
<li>بطارية ليثيوم تعمل حتى <strong>5 سنوات</strong></li>
...
<h2>معايرة</h2>
<p>نفس معايرة TÜRKAK، نفس الدقة ±0.2%، نفس الشهادة المعترف بها دولياً. الفرق الوحيد: استهلاك طاقة أقل.</p>`
}
],
...
<li>Работа с загрязнённой водой без потери точности</li>
<li>Диапазон: DN3–DN3000</li>
</ul>
...
<li>Устойчивая работа при высоком содержании твёрдой фазы</li>
</ul>
...
<ul>
<li>Транспорт рудной пульпы: DN100–DN400, полиуретан + Hastelloy</li>
<li>Техническая вода: DN50–DN300, эбонит + 316L</li>
<li>Дозирование реагентов: DN6–DN25, PTFE + Hastelloy</li>
</ul>

<p>Калибровка TÜRKAK ISO/IEC 17025. Сертификат признаётся во всех странах СНГ.</p>`
},
...
date:"2026-09-10",
image:"assets/products/NT-MLI-EX.png",
content:`<h2>Что нужно на НПЗ</h2>
<p>Нефтеперерабатывающие заводы <strong>SOCAR в Азербайджане</strong>, <strong>ТНПЗ в Туркменистане</strong> и предприятия в <strong>Грузии</strong> используют расходомеры и уровнемеры в десятках точек технологического процесса. Основные применения:</p>

<h3>Расходомеры</h3>
<ul>
<li><strong>Техвода (охлаждение, котлы, деминерализация):</strong> DN50–DN600, PTFE или эбонит, электроды 316L</li>
<li><strong>Буровой раствор:</strong> Высокочастотный 25/30 Гц, полиуретан, Hastelloy</li>
<li><strong>Дозирование химреагентов:</strong> DN6–DN25, PTFE, Hastelloy, высокая точность</li>
</ul>
...
<ul>
<li>Передатчик 4–20 мА для SCADA/DCS</li>
<li>Герконовые сигнализаторы уровня</li>
<li>Паровая рубашка для вязких продуктов</li>
</ul>

<p>Полная документация: сертификат гидроиспытания, сертификаты материалов 3.1, ATEX/IECEx.</p>`
},
...
<li>IP68: полная герметичность при затоплении</li>
<li>DN50–DN300</li>
</ul>
...
<p>Altın kural: akış hızını 1 m/s ile 5 m/s arasında tutun. Çok düşük hızda hassasiyet azalır, çok yüksek hızda liner aşınma riski artar.</p>
<ul>
<li><strong>Ham su alma:</strong> DN200–DN1200</li>
<li><strong>Filtre besleme hatları:</strong> DN150–DN600</li>
<li><strong>Kimyasal dozlama:</strong> DN3–DN25 (minyatür debimetreler)</li>
<li><strong>Dağıtım şebekesi:</strong> DN80–DN500</li>
</ul>
...
<h2>Çıkış ve Haberleşme</h2>
<ul>
<li><strong>4–20 mA + HART:</strong> Evrensel PLC/SCADA uyumluluğu</li>
<li><strong>RS485 Modbus RTU:</strong> Çoklu cihaz dijital ağları</li>
...
excerpt:"ISO/IEC 17025 akreditasyonu, kalibrasyon sertifikanızın 100'den fazla ülkede geçerli olmasını sağlar. İşte detaylar.",
category:"Kalibrasyon",
date:"2026-09-12",
image:"assets/products/NT-RCS-3100-2100.png",
content:`<h2>Kalibrasyon Nedir?</h2>
<p>Kalibrasyon, bir ölçüm cihazının gösterdiği değerin, bilinen bir referans standarda göre ne kadar saptığını belirleme işlemidir. Sonuç, bir <strong>kalibrasyon sertifikası</strong> ile belgelenir.</p>

<h2>Akrediteli mi, Akreditesiz mi?</h2>
<p>Herhangi bir firma "kalibrasyon sertifikası" verebilir. Ancak bu sertifikanın uluslararası geçerliliği için, kalibrasyonu yapan laboratuvarın <strong>ISO/IEC 17025 standardına göre akredite</strong> olması gerekir.</p>
<p>Net Flow'un kalibrasyon laboratuvarı, <strong>TÜRKAK (Türk Akreditasyon Kurumu)</strong> tarafından AB-0354-K numarası ile akredite edilmiştir. TÜRKAK, Avrupa Akreditasyon Birliği (EA) ve ILAC'ın tam üyesidir.</p>

<h2>Bu Ne Anlama Geliyor?</h2>
<ul>
<li>Sertifikamız <strong>100'den fazla ülkede</strong> otomatik olarak tanınır</li>
<li>Müşteri ülkesinde yeniden kalibrasyon gerekmez</li>
<li>Denetim ve uyumluluk süreçlerinde kabul görür</li>
<li>Ölçüm belirsizliği ±0,27% olarak belgelenir</li>
</ul>

<h2>Kalibrasyon Rigimiz</h2>
<p>Laboratuvarımızda DN3'ten DN1200'e kadar debimetreleri kalibre edebilen çoklu referans hattı bulunur. Her hat, gravimetrik (tartım bazlı) yöntemle en yüksek doğruluğu sağlar.</p>
<ul>
<li><strong>Küçük DN hattı:</strong> DN3–DN50, hassas tartım sistemi</li>
<li><strong>Orta DN hattı:</strong> DN50–DN300, yüksek hacimli kalibrasyon tankı</li>
<li><strong>Büyük DN hattı:</strong> DN300–DN1200, endüstriyel ölçekli rig</li>
</ul>

<h2>İhracat Müşterileri İçin</h2>
<p>Irak, Azerbaycan, Kazakistan, Fas, Nijerya ve diğer ihracat pazarlarımızda müşteriler, cihaz ile birlikte gelen TÜRKAK sertifikasını doğrudan kullanabilir. Ek kalibrasyon maliyeti ve süresi ortadan kalkar.</p>`
},
{slug:"su-idareleri-kayip-kacak-debimetre",
title:"Su İdarelerinde Kayıp-Kaçak Oranını Düşürmek: Bölge Sayaçları ile DMA Uygulaması",
excerpt:"Türkiye'de bazı su idarelerinde kayıp-kaçak oranı %40'ı geçiyor. Doğru debimetre seçimi ve DMA kurulumu ile bu oran %15'e düşürülebilir.",
category:"Su İdareleri",
date:"2026-09-10",
image:"assets/products/NT-VMF-W.png",
content:`<h2>Kayıp-Kaçak: Görmezden Gelinemeyecek Bir Sorun</h2>
<p>İSKİ, ASKİ, KOSKİ ve Türkiye'nin pek çok su idaresi aynı sorunla boğuşuyor: üretilen suyun önemli bir kısmı tüketiciye ulaşmadan kayboluyor. Fiziksel sızıntılar, kaçak bağlantılar, yaşlanmış mekanik sayaçların hata payı ve faturalanmayan tüketim.</p>
...
<ul>
<li>Sediment ve kireç ile tıkanır, 2–3 yılda hassasiyet kaybeder</li>
<li>Basınç kaybı oluşturur</li>
<li>Ters akış ölçemez</li>
<li>Gece debisi analizi için yeterli hassasiyete sahip değildir</li>
</ul>

<h2>NT-VMF ile DMA Kurulumu</h2>
<ul>
<li>Hassasiyet: ±0,2% (TÜRKAK kalibrasyonlu)</li>
<li>Boş boru algılama: bakım sırasında yanlış okuma önler</li>
<li>Düşük debi kesme: gece akışı analizinde gürültüyü yok eder</li>
<li>Çift yönlü ölçüm: ters akışları yakalar</li>
<li>IP68: su basan sayaç odalarında sorunsuz çalışır</li>
</ul>

<h2>Geri Dönüş</h2>
<p>Günlük 100.000 m³ üreten bir idarede kayıp-kaçak oranını %40'tan %25'e düşürmek, günde <strong>15.000 m³</strong> suyu kurtarmak demektir. DMA yatırımı genellikle 12–18 ayda kendini amorti eder.</p>`
},
{slug:"manyetik-bypass-seviye-gostergesi-rehber",
title:"Manyetik Bypass Seviye Göstergesi: Cam Seviye Göstergelerine Son",
...
<ul>
<li>Merkezden merkeze mesafe (C/C)</li>
<li>Flanş standardı ve boyutu (DIN, ANSI, JIS)</li>
<li>Çalışma basıncı ve sıcaklığı</li>
<li>Sıvı özgül ağırlığı</li>
</ul>

<h2>Opsiyonlar</h2>
<ul>
<li>4–20 mA transmitter ile SCADA'ya uzaktan izleme</li>
<li>Reed switch seviye alarmları</li>
<li>Viskoz sıvılar için buhar ceketli versiyon</li>
</ul>

<p>Her ünite basınç testi yapılarak ve belgelenerek sevk edilir. ATEX/IECEx sertifikaları Ex-rated modeller için dahildir.</p>`
},
{slug:"atiksu-aritma-debimetre-secimi",
title:"Atıksu Arıtma Tesislerinde Debimetre Seçimi: Neye Dikkat Etmeli?",
excerpt:"Atıksu agresif, öngörülemeyen ve katı madde dolu bir ortamdır. Yanlış debimetre seçimi, cihazın kendisinden daha pahalıya mal olur.",
category:"Atıksu Arıtma",
date:"2026-09-06",
image:"assets/products/NT-VMF-P.png",
content:`<h2>Atıksu, Temiz Su Değildir</h2>
...
<h3>Elektrot</h3>
<ul>
<li><strong>316L:</strong> Evsel atıksu için yeterli.</li>
<li><strong>Hastelloy C-276:</strong> Klorür veya asit içeren endüstriyel atıksu.</li>
</ul>

<h2>Kritik Özellikler</h2>
<ul>
<li><strong>Boş boru algılama:</strong> Tank boşaltma veya pompa durması sırasında yanlış okumaları önler.</li>
<li><strong>Kendini temizleyen elektrot geometrisi:</strong> Yağ birikimini minimize eder.</li>
<li><strong>IP68 koruma:</strong> Atıksu debimetre odaları düzenli olarak su basar.</li>
</ul>

<p>Giriş yapısından son çıkış suyuna kadar, tesisin her ölçüm noktası için doğru cihazı yapılandırabiliriz.</p>`
}
]
};
